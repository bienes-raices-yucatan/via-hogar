'use server';
/**
 * @fileOverview A geocoding AI agent that converts an address to latitude and longitude coordinates.
 *
...
Please provide the latitude and longitude in JSON format.`, config: {
    safetySettings: [
      {
