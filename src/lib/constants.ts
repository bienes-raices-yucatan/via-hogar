    ...
    switch (type) {
        ...
        case 'imageWithFeatures':
             const defaultFeatures: FeatureItem[] = [
                ...
                { id: `feat-3-${uniqueSuffix}`, icon: 'pool', title: { text: 'Piscina totalmente equipada', fontSize: 1.125, color: '#1E293B', fontFamily: 'Montserrat', textAlign: 'left', fontWeight: 'bold' }, description: { text: 'Con cascada y sistema de filtrado.', fontSize: 1, color: '#475569', fontFamily: 'Poppins', textAlign: 'left', fontWeight: 'normal' } },
                { id: `feat-4-${uniqueSuffix}`, icon: 'parking', title: { text: '2 espacios de estacionamiento', fontSize: 1.125, color: '#1E293B', fontFamily: 'Montserrat', textAlign: 'left', fontWeight: 'bold' }, description: { text: 'Techados y cerrados.', fontSize: 1, color: '#475569', fontFamily: 'Poppins', textAlign: 'left', fontWeight: 'normal' } },
            ];
            return {
                ...base,
