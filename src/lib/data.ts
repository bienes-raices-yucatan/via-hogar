    ...
    sections: [
      ...
      },
      {
       ...
       },
       {
        ...
        type: 'CONTACT',
        style: { backgroundColor: '#e0f2fe' },
        imageUrl: 'https://picsum.photos/seed/contact1/1920/1080',
        title: { text: '¿Interesado en esta propiedad?', fontSize: 'clamp(2rem, 4vw, 3rem)', color: '#1E293B', fontFamily: 'Montserrat' },
        subtitle: { text: 'Completa el formulario y un agente se pondrá en contacto contigo a la brevedad.', fontSize: 'clamp(1rem, 2vw, 1.15rem)', color: '#475569', fontFamily: 'Roboto' },
