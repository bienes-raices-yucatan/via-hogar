    ...
    sections: [
      ...
      },
      {
       ...
       },
       {
        ...
        type: 'CONTACT',
        style: { backgroundColor: '#ffffff' },
        title: { text: 'Completa y envía el formulario para contactarte.', fontSize: 2, color: '#1E293B', fontFamily: 'Montserrat' },
        subtitle: { text: 'Resolveremos tus dudas y podrás agendar una visita.', fontSize: 1.1, color: '#475569', fontFamily: 'Roboto' },
        buttonText: 'Enviar',
      },
    ],
  },
