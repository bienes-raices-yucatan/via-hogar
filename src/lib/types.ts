...
export type SelectedElement = {
    ...
    property?: keyof (FeatureItem | PricingTier | StyledText | ButtonSectionData | NearbyPlace | AmenityItem | ImageWithFeaturesSectionData); // For nested properties within an item
};
