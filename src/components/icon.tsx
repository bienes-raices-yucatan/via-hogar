...
export const Icon: React.FC<IconProps> = ({ name, className = 'w-6 h-6', strokeWidth = 1.5, ...props }) => {
  const icons: { [key in IconName]: React.ReactElement } = {
    ...
    copyright: <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm-2-14h4v1.5h-4z M10 12c0-1.1.9-2 2-2s2 .9 2 2-.9 2-2 2-2-.9-2-2z"/>,
