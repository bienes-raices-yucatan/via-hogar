...
export const Icon: React.FC<IconProps> = ({ name, className = 'w-6 h-6', strokeWidth = 1.5, ...props }) => {
  // FIX: Replaced JSX.Element with React.ReactElement to fix namespace issue.
  ...
  const iconElement = React.cloneElement(iconSvg, {
      className: name === 'logo' ? className : undefined, // Special handling for logo fill
      ...props,
  });
